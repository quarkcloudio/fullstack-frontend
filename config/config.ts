          ...
          routes: [
            ...
            },
            {
              ...
              routes: [
                ...
                {
                  path: '/mall/goods/attributeIndex',
                  name: 'attributeIndex',
                  component: './Mall/Goods/AttributeIndex',
                },
                {
                  path: '/mall/goods/attributeCreate',
                  name: 'attributeCreate',
                  component: './Mall/Goods/AttributeCreate',
                },
                {
                  path: '/mall/goods/attributeEdit',
                  name: 'attributeEdit',
                  component: './Mall/Goods/AttributeEdit',
                },
                {
                  path: '/mall/goods/specificationIndex',
                  name: 'specificationIndex',
                  component: './Mall/Goods/SpecificationIndex',
                },
                {
                  path: '/mall/goods/specificationCreate',
                  name: 'specificationCreate',
                  component: './Mall/Goods/SpecificationCreate',
                },
                {
                  path: '/mall/goods/specificationEdit',
                  name: 'specificationEdit',
                  component: './Mall/Goods/SpecificationEdit',
                },
                {
