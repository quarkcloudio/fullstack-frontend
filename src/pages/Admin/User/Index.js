...
class IndexPage extends PureComponent {
  ...
  handleCreate = () => {
    ...
    dispatch(
      routerRedux.push({
        pathname: '/' + this.modelName + '/user/create',
      }),
    );
  };
  ...
  handleEdit = id => {
    ...
    dispatch(
      routerRedux.push({
        pathname: '/' + this.modelName + '/user/edit',
        query: { id: id },
      }),
    );
  };
    ...
    const columns = [
      {
        ...
        key: 'username',
        render: (text, record) => (
          <a href="javascript:;" onClick={() => this.handleEdit(record.id)}>
            {text}
          </a>
        ),
      },
        ...
        <div className={styles.container}>
          <div className={styles.tableHeader}>
            <Row type="flex" justify="start">
              <Col span={12}>
                <h5 className={styles.tableHeaderTitle}>管理员列表</h5>
              </Col>
              <Col span={12}>
                  ...
                  <Form layout="inline" onSubmit={this.handleSearch}>
                    ...
                    <Form.Item style={{ display: 'inline-block' }}>
                      {getFieldDecorator('username')(
                        <Input placeholder="请输入要搜索的用户" style={{ width: 200 }} />,
                      )}
                    </Form.Item>
                    <Form.Item style={{ display: 'inline-block' }}>
          ...
          >
            <Row>
              <Col span={24}>
                <Form layout="inline" onSubmit={this.handleSearch}>
                  <Form.Item label="用户名" style={{ display: 'inline-block' }}>
                    {getFieldDecorator('username')(
                      <Input placeholder="请输入要搜索的用户名" style={{ width: 200 }} />,
                    )}
                  </Form.Item>
                  <Form.Item label="昵称" style={{ display: 'inline-block' }}>
                    {getFieldDecorator('nickname')(
                      <Input placeholder="请输入昵称" style={{ width: 160 }} />,
                    )}
                  </Form.Item>
                  <Form.Item label="邮箱" style={{ display: 'inline-block' }}>
