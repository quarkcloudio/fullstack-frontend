...
class IndexPage extends PureComponent {
  ...
  handleCreate = () => {
    ...
    dispatch(
      routerRedux.push({
        pathname: '/banner/' + this.modelName + '/create',
      }),
    );
  };
  ...
  handleEdit = id => {
    ...
    dispatch(
      routerRedux.push({
        pathname: '/banner/' + this.modelName + '/edit',
        query: { id: id },
      }),
    );
  };
          ...
          return (
            <div style={{ width: '100px', height: '30px', overflow: 'hidden' }}>
              <a
                href="javascript:;"
                onClick={() => {
                  this.setState({ previewVisible: true, previewImage: record.path });
                }}
              >
                <img src={text.cover_path} alt="" style={{ width: '100%' }} />
              </a>
            </div>
          );
        },
        ...
        <div className={styles.container}>
          <div className={styles.tableHeader}>
            <Row type="flex" justify="start">
              <Col span={12}>
                <h5 className={styles.tableHeaderTitle}>广告列表</h5>
              </Col>
              <Col span={12}>
