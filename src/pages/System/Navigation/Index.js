        ...
        <div className={styles.container}>
          <div className={styles.tableHeader}>
            <Row type="flex" justify="start">
              <Col span={12}>
                <h5 className={styles.tableHeaderTitle}>导航列表</h5>
              </Col>
              <Col span={12}>
          ...
          >
            <Form layout="horizontal" onSubmit={this.handleSaveFormData}>
              ...
              <Form.Item style={{ marginBottom: 8 }} {...formItemLayout} label="父节点">
                {getFieldDecorator('pid', {
                  ...
                  <Select style={{ width: 200 }} placeholder="选择父节点">
                    {this.state.data.TreeLists.length !== 0
                      ? this.state.data.TreeLists.map(d => <Option key={d.id}>{d.title}</Option>)
              ...
              <Form.Item label="url" {...formItemLayout} style={{ marginBottom: 8 }}>
                {getFieldDecorator('url', {
                  initialValue: this.state.form.url,
                })(<Input className={styles.smallItem} placeholder="请输入url" />)}
              </Form.Item>
          ...
          >
            <Form layout="horizontal" onSubmit={this.handleStoreFormData}>
              <Form.Item label="标题" {...formItemLayout} style={{ marginBottom: 8 }}>
                {getFieldDecorator('title')(
